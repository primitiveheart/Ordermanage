	...
	<%@include file="../commons/menu.jsp"%>
  	...
  	<div class="ui container">
  		...
  		<div class="ui blue button back left icon">
  			...
  			返回
  		</div><div class="ui button copy">复制链接</div>
  		
		<div class="ui header">矢量数据</div>
	...
	<script>
	    $(document).ready(function(){
	    	...
	    	if(shape == "adminRegion"){
	    		...
	    		$.ajax({
	    			url:"home/getFeaturesByRegionId.html",
	    			type:"get",
	    			data:{
	    				productId:productId
	    			},
	    			success:function(result){
	    				$(".result_display_sum").text(result.features);
	    			}
	    		})
	    		copyLink = basepath + "home/getFeaturesByRegionId.html?productId=" + productId;
	    		*/
	    	...
	    	$.ajax({  
			      ...
			      success:function(result){  
			    	  ...
			    	  $(".result_display_vector").text(serialized);
			      },  
			      error: function(){  
			        alert("执行失败");    
			      }  
